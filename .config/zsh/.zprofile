...
export XSERVERRC="$XDG_CONFIG_HOME"/X11/xserverrc # X server configuration
export XINITRC="$XDG_CONFIG_HOME"/X11/xinitrc     # X Window System initialization
export XAUTHORITY="$XDG_RUNTIME_DIR"/Xauthority   # X server authority
